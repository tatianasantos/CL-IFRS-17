...
Summary_85_CP <- data.frame("Element"=c("SD_A", "Skewness_A","SD_B", "Skewness_B"),
                            "RBNS"=c(qnorm(0.85)*sqrt(MOM_RBNS_CP_A[2]),
                                     ((qnorm(0.85)^2-1)*MOM_RBNS_CP_A[3])/(6*MOM_RBNS_CP_A[2]),
                                     qnorm(0.85)*sqrt(MOM_RBNS_CP_B[2]),
                                     ((qnorm(0.85)^2-1)*MOM_RBNS_CP_B[3])/(6*MOM_RBNS_CP_B[2])),
                            "IBNR"=c(qnorm(0.85)*sqrt(MOM_IBNR_CP_A[2]),
                                     ((qnorm(0.85)^2-1)*MOM_IBNR_CP_A[3])/(6*MOM_IBNR_CP_A[2]),
                                     qnorm(0.85)*sqrt(MOM_IBNR_CP_B[2]),
                                     ((qnorm(0.85)^2-1)*MOM_IBNR_CP_B[3])/(6*MOM_IBNR_CP_B[2])),
                            "IBNS"=c(qnorm(0.85)*sqrt(MOM_RBNS_CP_A[2]+MOM_IBNR_CP_A[2]),
                                     ((qnorm(0.85)^2-1)*(MOM_RBNS_CP_A[3]+MOM_IBNR_CP_A[3]))/(6*(MOM_RBNS_CP_A[2]+MOM_IBNR_CP_A[2])),
                                     qnorm(0.85)*sqrt(MOM_RBNS_CP_B[2]+MOM_IBNR_CP_B[2]),
                                     ((qnorm(0.85)^2-1)*(MOM_RBNS_CP_B[3]+MOM_IBNR_CP_B[3]))/(6*(MOM_RBNS_CP_B[2]+MOM_IBNR_CP_B[2]))),
                            "CBNI"=c(qnorm(0.85)*sqrt(MOM_CBNI_CP_A[2]),
                                     ((qnorm(0.85)^2-1)*MOM_CBNI_CP_A[3])/(6*MOM_CBNI_CP_A[2]),
                                     qnorm(0.85)*sqrt(MOM_CBNI_CP_B[2]),
                                     ((qnorm(0.85)^2-1)*MOM_CBNI_CP_B[3])/(6*MOM_CBNI_CP_B[2])))
