...
D_RBNS_A <- uniroot(f,c(0,2),CF_UNDISC=CF_RBNS_UNDISC_A, CF_DISC=CF_RBNS_DISC_A, tol=0.000000000001)$root
D_IBNR_A <- uniroot(f,c(0,1),CF_UNDISC=CF_IBNR_UNDISC_A, CF_DISC=CF_IBNR_DISC_A, tol=0.000000000001)$root
D_CBNI_A <- uniroot(f,c(0,1),CF_UNDISC=CF_CBNI_UNDISC_A, CF_DISC=CF_CBNI_DISC_A, tol=0.000000000001)$root
...
D_RBNS_B <- uniroot(f,c(0,2),CF_UNDISC=CF_RBNS_UNDISC_B, CF_DISC=CF_RBNS_DISC_B, tol=0.000000000001)$root
D_IBNR_B <- uniroot(f,c(0,1),CF_UNDISC=CF_IBNR_UNDISC_B, CF_DISC=CF_IBNR_DISC_B, tol=0.000000000001)$root
D_CBNI_B <- uniroot(f,c(0,1),CF_UNDISC=CF_CBNI_UNDISC_B, CF_DISC=CF_CBNI_DISC_B, tol=0.000000000001)$root
